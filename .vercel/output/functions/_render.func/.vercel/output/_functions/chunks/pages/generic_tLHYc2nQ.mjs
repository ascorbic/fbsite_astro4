import { i as isESMImportedImage, a as isLocalService, b as isRemoteImage, D as DEFAULT_HASH_PROPS, c as isRemotePath, d as isRemoteAllowed } from '../astro/assets-service_WfKt770Z.mjs';
import mime from 'mime/lite.js';
import { A as AstroError, e as InvalidImageService, f as ExpectedImageOptions, E as ExpectedImage, c as createAstro, d as createComponent, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes } from '../astro_ffjFK0U-.mjs';
import 'html-escaper';
import 'clsx';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_WfKt770Z.mjs'
    ).then(n => n.g).catch((e) => {
